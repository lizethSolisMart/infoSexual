    ...
    return (
        <div className="p-6 space-y-6">
            <Image 
                ...
                src="/images/esposa-esposo-peleando.jpg" // esposa-esposo-peleando.jpg
                width={400}
            />

            <h1 className="text-3xl font-bold">Relaciones Sanas: El Arte del Equilibrio y la Armonía</h1>
